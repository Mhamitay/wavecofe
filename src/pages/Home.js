...
function Home() {
  return (
    <>
            ...
            <main class="tm-main">
                  ...
                  <div class="tm-list">
                    ...
                    <div class="tm-list-item">
                      ...
                      <div class="tm-black-bg tm-list-item-text">
                        ...
                        <p class="tm-list-item-description">
                          Here is a list of 4 items or add more. You can use
                          this template for commercial purposes.
                        </p>
                      </div>
                    </div>
                    <div class="tm-list-item">
                      ...
                      <div class="tm-black-bg tm-list-item-text">
                        ...
                        <p class="tm-list-item-description">
                          You are not permitted to redistribute this template
                  ...
                  <div class="tm-list">
                    ...
                    <div class="tm-list-item">
                      ...
                      <div class="tm-black-bg tm-list-item-text">
                        ...
                        <p class="tm-list-item-description">
                          Here is a list of 4 items that can add more as you
                          need. Only content area will be scrolling.
                        </p>
                      </div>
                    </div>
                    <div class="tm-list-item">
              ...
              <div id="about" class="tm-page-content">
                <div class="tm-black-bg tm-mb-20 tm-about-box-1">
                  <h2 class="tm-text-primary tm-about-header">
                    About Wave Cafe
                  </h2>
                  <div class="tm-list-item tm-list-item-2">
                    ...
                    <div class="tm-list-item-text-2">
                      <p>
                        Wave Cafe is a one-page video background HTML CSS
                        template from Tooplate. You can use this for your
                        business websites.
                      </p>
                      <p>
                ...
                <div class="tm-black-bg tm-mb-20 tm-about-box-2">
                  <div class="tm-list-item tm-list-item-2">
                    <div class="tm-list-item-text-2">
                      ...
                      <p>
                        If you wish to support us, please contact Tooplate.
                        Thank you. Duis bibendum erat nec ipsum consectetur
                        sodales.
                      </p>
                    </div>
                    <img
                  ...
                  <p>
                    Donec non urna elit. Quisque ut magna in dui mattis iaculis
                    eu finibus metus. Suspendisse vel mi a lacus finibus
                    vehicula vel ut diam. Nam pellentesque, mi quis ullamcorper.
                  </p>
                </div>
              </div>
                ...
                <div class="tm-special-items">
                  ...
                  <div class="tm-black-bg tm-special-item">
                    ...
                    <div class="tm-special-item-description">
                      ...
                      <p class="tm-special-item-text">
                        You are allowed to download, modify and use this
                        template for your commercial or non-commercial websites.
                      </p>
                    </div>
                  </div>
                  <div class="tm-black-bg tm-special-item">
                  ...
                  <div class="tm-black-bg tm-special-item">
                    ...
                    <div class="tm-special-item-description">
                      ...
                      <p class="tm-special-item-text">
                        Here is a short text description for sixth item. This
                        text is four lines.
                      </p>
                    </div>
                  </div>
                  <div class="tm-black-bg tm-special-item">
                    ...
                    <div class="tm-special-item-description">
                      ...
                      <p class="tm-special-item-text">
                        Curabitur eget erat sit amet sapien aliquet vulputate
                        quis sed arcu.
                      </p>
                    </div>
                  </div>
      ...
      <div class="tm-video-wrapper" style={{ backgroundColor: "black" }}>
        <i id="tm-video-control-button" class="fas fa-pause"></i>
        <video autoPlay muted loop id="tm-video">
          <source
            src="https://v.ftcdn.net/01/34/00/58/240_F_134005836_HHklRSGRc3MdAInV4OpQj2GkI78nqjOx_ST.mp4"
            type="video/mp4"
          />
        </video>
      </div>
